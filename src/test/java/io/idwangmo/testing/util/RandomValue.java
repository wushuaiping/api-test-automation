 ...
 *
 * @author loki
 * @Date 2019-01-04 15:21
 * @since 1.0
 */
public class RandomValue {

    private static String[] telFirst = "131,135,136,137,138,152,155,158,159,177,171".split(",");
    ...
    public static String getTel() {
        ...
        String firstPart = telFirst[index];
        String secendPart = String.valueOf(getNum(1, 9999) + 10000).substring(1);
        String thirdPart = String.valueOf(getNum(1, 9999) + 10000).substring(1);
    ...
    public static String getName() {
        ...
        String lastName = firstName.substring(index, index + 1);
